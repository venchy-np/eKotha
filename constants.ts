...
export const TRANSLATIONS = {
  en: {
    ...
    home: "Home",
    rent_rooms_in_nepal: "Rent Rooms in Nepal",
    ...
    lister_dashboard: "Lister Dashboard",
    available: "Available",
    ...
    secure_payment: "Secure Payment via",
    pull_down: "Pull Down",
    release: "Release",
  ...
  np: {
    ...
    home: "गृह",
    rent_rooms_in_nepal: "नेपालमा कोठा भाडामा लिनुहोस्",
    featured_rooms: "विशेष कोठाहरू",
    list_a_room: "कोठा राख्नुहोस्",
    verify_kyc: "KYC प्रमाणित गर्नुहोस्",
    language: "भाषा",
    appearance: "देखावट",
    sign_out: "लग आउट",
    admin_dashboard: "व्यवस्थापक ड्यासबोर्ड",
    your_rooms: "तपाईंका कोठाहरू",
    lister_dashboard: "घरधनी ड्यासबोर्ड",
    available: "उपलब्ध",
    monthly_rent: "मासिक भाडा",
    chat: "च्याट",
    verified_owner: "प्रमाणित घरधनी",
    about_this_place: "यस ठाउँको बारेमा",
    amenities: "सुविधाहरू",
    payment_methods: "स्वीकृत भुक्तानी विधिहरू",
    secure_payment: "सुरक्षित भुक्तानी",
    pull_down: "तल तान्नुहोस्",
    release: "छोड्नुहोस्",
